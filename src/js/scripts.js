...
criarItemDeAtividade = (atividade) => {
    ...
    <div class="card-bg">
      ...
      <span style="color: white;">${atividade.nome}</span>
      </div>
            
                <time>
                    ${formatarInicio.dia.semana.longo}, dia ${formatarInicio.dia.numerico} de ${formatarInicio.mes} às ${formatarInicio.hora}h    
...
if(atividades.length == 0) {
    section.innerHTML = `<p style="color: #71717a ;">Nenhuma atividade cadastrada</p>`
    return
}
